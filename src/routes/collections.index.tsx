  ...
  head: () => ({
    meta: [
      { title: "Collections — House of Lumere" },
      {
        name: "description",
        content:
          "Editorial collections of luxury chandeliers, pendants, sconces, ceiling lights, floor & table lamps and decorative lighting.",
      },
      { property: "og:title", content: "Collections — House of Lumere" },
      {
        property: "og:description",
        content:
          "Editorial collections of luxury lighting, drawn at architectural scale.",
      },
    ],
  }),
        ...
        title={
          <>
            ...
            <em className="not-italic text-muted-foreground">
              light, drawn at architectural scale.
            </em>
          </>
        }
