  ...
  head: () => ({
    meta: [
      { title: "Projects — House of Lumere" },
      {
        name: "description",
        content:
          "Selected residential, hospitality and architectural projects lit by House of Lumere.",
      },
      { property: "og:title", content: "Projects — House of Lumere" },
      {
        property: "og:description",
        content:
          "A portfolio of residences, penthouses, hotels and ateliers shaped by our lighting.",
      },
    ],
  }),
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <h2 className="font-serif text-4xl md:text-5xl leading-[1.05] mb-8 group-hover:text-brass transition-colors duration-300">
                    {p.title}
                  </h2>
                  <p className="text-muted-foreground text-base md:text-lg leading-relaxed mb-8">
                    {p.body}
                  </p>
                  <span className="link-underline text-[11px] uppercase tracking-[0.28em]">
                    View case study →
                  </span>
                </div>
              </Link>
